...
const PromptsManager = ({ onSubmit, selectionType }: PromptsManagerProps) => {
  const [filledPrompts, setFilledPrompts] = React.useState<Map<Prompt | EventPrompt, string>>(new Map());
